// THIS FILE IS USED IN ORDER TO PERFORM TESTS ON THE MATRIX CLASS FOR ROW MAJOR MATRIX
#include "Matrix.hpp"
...
int main(int argc, char* argv[]){
    ...
    if (argc == 2){
        ...
        Matrix<double, ROW_MAJOR> A(filename1);
        ...
        Matrix<double, ROW_MAJOR> A(filename1);
        Matrix<double, ROW_MAJOR> B(filename2);
        ...
        std::cerr << "Usage should be either ./test_rowmajor <filename> to test basic class functions or ./test_rowmajor <filename1> <filename2> to test matrix product" << std::endl;
        return -1;
    }
